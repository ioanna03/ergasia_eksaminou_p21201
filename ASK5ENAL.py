    ...
    for word in counter:
        ...
        if len(word) > 1:
            for word_2 in counter:
                ...
                if len(word_2) > 1:
                    if word[:2] == word_2[
                                   :2] and word is not word_2 and word not in combinationsFor2Letters and word_2 not in combinationsFor2Letters:
                        combinationsFor2Letters.append([word, word_2])
                    if word[:3] == word_2[
                                   :3] and word is not word_2 and word not in combinationsFor3Letters and word_2 not in combinationsFor3Letters:
